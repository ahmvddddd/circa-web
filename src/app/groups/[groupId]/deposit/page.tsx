...
//     setLoading(true);
//     try {
//       const res = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/v1/deposits/${groupId}/init`, {
//         method: "POST",
...
//       router.push(
//         `/groups/${groupId}/deposit/tracking/${data.public_read_token}`
//       );
//     } finally {
//       setLoading(false);
//     }
...
//   >
//     {loading ? "Generating tracking link..." : "View Deposit Tracking"}
//   </button>
// </div>
//     </AppShell>
//   );
  ...
  const handleStartTracking = async () => {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/v1/deposits/d4bfb4cb-8d12-4236-949a-fe4b48cee62f/init`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
